...
def disable_proxy_for_internal_services(url: str, service_name: str = "service") -> None:
    ...
    NOTE: This function is disabled. SSL certificate configuration via
    SSL_CERT_FILE environment variable is the recommended approach instead.
    ...
    """
    # Proxy handling disabled - SSL certificate configuration recommended instead
    # See: SSL_CERT_FILE="/usr/share/ca-certificates/extra/McAfee_Certificate.crt"
    pass
